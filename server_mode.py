...
class GTerminalReactServer:
    ...
    async def _start_http_server(self):
        ...
        logger.info(f"   POST /process - Process request immediately")
        logger.info(f"   POST /queue   - Queue request for background processing")
        logger.info(f"   GET  /result/{{id}} - Get result by request ID")
        logger.info(f"   GET  /status  - Server status and metrics")
